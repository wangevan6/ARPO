#!/bin/bash
# ARPO Toy Training Script - Qwen2.5-0.5B-Instruct
# Fallback for 16GB VRAM if 3B model OOMs
...
n# PyTorch CUDA workarounds for WSL2 + Ray compatibility
export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True
export CUDA_LAUNCH_BLOCKING=0

# Set Python path (absolute path for Windows)
export PYTHONPATH="/mnt/c/Users/user/Projects/ARPO/ARPO/verl_arpo_entropy:$PYTHONPATH"

# ============================ Basic Configuration ============================
PROJECT_NAME="toy_testing"
EXPERIMENT_NAME="ARPO_0.5B_Toy_Local"

# Configuration file path (absolute path for Windows)
CONFIG_PATH="/mnt/c/Users/user/Projects/ARPO/ARPO/scripts/config"
...
VALID_FILES="/mnt/c/Users/user/Projects/ARPO/ARPO/rl_datasets/valid.parquet"

# ============================ Model Configuration ============================
# Actor model path - using 0.5B model (already downloaded in LLaMA-Factory)
ACTOR_MODEL_PATH="/mnt/c/Users/user/Projects/ARPO/LLaMA-Factory/models/Qwen2.5-0.5B-Instruct"
...
SEARCH_CACHE_PATH="/mnt/c/Users/user/Projects/ARPO/ARPO/search_cache/search_cache.json"
...
CUSTOM_REWARD_FUNCTION_PATH="/mnt/c/Users/user/Projects/ARPO/ARPO/verl_arpo_entropy/verl/utils/reward_score/deep_research.py"
...
# ============================ Path Configuration ============================
SAVE_PATH="/mnt/c/Users/user/Projects/ARPO/ARPO/checkpoints_toy/${EXPERIMENT_NAME}"
...
mkdir -p "/mnt/c/Users/user/Projects/ARPO/ARPO/search_cache"
...
# ============================ Start Training ============================
echo "==========================================="
echo "Starting ARPO Toy Training - 0.5B Model"
echo "==========================================="
