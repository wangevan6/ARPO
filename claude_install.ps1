...
</style></div><div data-padding-bottom="none" data-padding-top="none" class="guide_contain u-container"><div class="guide_layout"><div class="guide_column"></div><div class="guide_column"></div><div class="guide_column"></div><div class="guide_column"></div><div class="guide_column"></div><div class="guide_column"></div><div class="guide_column"></div><div class="guide_column"></div><div class="guide_column"></div><div class="guide_column"></div><div class="guide_column"></div><div class="guide_column"></div><div class="guide_column"></div><div class="guide_column"></div><div class="guide_column"></div><div class="guide_column"></div><div class="guide_column"></div><div class="guide_column"></div><div class="guide_column"></div><div class="guide_column"></div><div class="guide_column"></div><div class="guide_column"></div><div class="guide_column"></div><div class="guide_column"></div></div></div></div><div class="nav_component"><div class="w-embed"><style>
  :root {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  (function () {
    ...
    function initAskPage(){
      document.querySelectorAll('[data-ask-page]').forEach(function(btn){
    ...
    function ensureTurndown(){
      ...
      _turndownReady = new Promise(function(resolve){
      ...
      copyButton.addEventListener('click', function(){
        ensureTurndown().then(function(){
          try {
            ...
            setTimeout(function(){
              buttonTextEl.textContent = 'Copy as Markdown';
              copyButton.disabled = false;
            }, 2000);
          }
        });
    ...
    // Optional: expose minimal API for debugging
    window.NavBundle = {
